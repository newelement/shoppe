    ...
    <div class="container">
        <div class="content">
            <div class="title-search">
                <h2>Subscription Plans <a class="headline-btn" href="/admin/subscription-plan" role="button">Create New Plan</a></h2>
            </div>
                    ...
                    @foreach( $subs as $sub )
                        <tr>
                            <td data-label="Plan ID">
                                <a href="/admin/subscription-plans/{{ $sub['id'] }}">{{ $sub['id'] }}</a>
                            </td>
                            ...
                            <td data-label="Manage" class="text-center"><a href="/admin/subscription-plans/{{ $sub['id'] }}">Edit</a></td>
                            <td class="text-center">
                                <form action="/admin/subscription-plans/{{ $sub['id'] }}" method="post">
                                    @csrf
                                    @method('delete')
