    ...
    <div class="container">
        <div class="content full">
            <div class="title-search">
                <h2>Edit Subscription Plan <a class="headline-btn" href="/admin/subscription" role="button">Create New Plan</a></h2>
            </div>

            <form action="/admin/subscriptions/{{ $plan['id'] }}" method="post">
                @csrf
                @method('put')
