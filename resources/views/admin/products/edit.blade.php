...
<form action="/admin/product/{{ $product->id }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container">
        <div class="content">
            ...
            @if( $subscriptions )
            <div id="product-subscription-row" class="form-row" @if( $product->product_type !== 'subscription' ) style="display: none;" @endif>
                ...
                <div class="input-col">
                    <div class="select-wrapper">
                        <select id="subscription-id" name="subscription_id">
                            ...
                            <option value="{{$subscription['id']}}" {{ $product->subscription_id === $subscription['id'] ? 'selected="selected"' : '' }}>{{$subscription['name']}} - {{$subscription['amount']}} {{$subscription['interval']}}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                    ...
                    <div id="tab2" class="tab-content">
                        ...
                        <div id="shipping-rate-row" class="form-row" style="display: none">
                            <label class="label-col" for="shipping-rate">Shipping Rate</label>
                                    <div class="input-col">
                                        <input type="number" id="shipping-rate" name="shipping_rate" value="{{ old('shipping_rate', $product->shipping_date) }}" step="0.01">
                                    </div>
                                    <span class="input-notes"><span class="note">This setting will override the global shipping setting.</span></span>
                        </div>
